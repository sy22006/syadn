...
public class HeaderLayout extends LinearLayout {
	...
	private void titleLeftImageButton() {
		...
		mLeftImageButton = (Button) mleftImageButtonView
...
//			mLeftImageButton.setBackgroundResource(id);
			
			Drawable drawable= getResources().getDrawable(id);
			drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
			mLeftImageButton.setCompoundDrawables(drawable,null,null,null);
			
			setOnLeftImageButtonClickListener(listener);
		}
		mLayoutRightContainer.setVisibility(View.INVISIBLE);
	}
	public void setTitleAndLeftImageButton(CharSequence title, CharSequence leftTitle, int id, onLeftImageButtonClickListener listener) {
		setDefaultTitle(title);
		if (mLeftImageButton != null && id > 0) {
//			mLeftImageButton.setImageResource(id);
//			mLeftImageButton.setBackgroundResource(id);
			...
			drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
			mLeftImageButton.setCompoundDrawables(drawable,null,null,null);
			mLeftImageButton.setText(leftTitle);
	...
	/*public void setTitleAndLeftImageButton(String title, int id,
			FragmentActivity activity) {
		setDefaultTitle(title);
		if (mLeftImageButton != null && id > 0) {
			mLeftImageButton.setImageResource(id);
			((MainActivity) activity).myAccount();
			setOnLeftImageButtonClickListener(listener);
		}
		mLayoutRightContainer.setVisibility(View.INVISIBLE);
	}*/
