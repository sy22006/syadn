...
public class BaseActivity extends FragmentActivity {
	...
	public void initTopBarForLeft(String titleName, String leftTitle) {
		mHeaderLayout = (HeaderLayout)findViewById(R.id.common_actionbar);
		mHeaderLayout.init(HeaderStyle.TITLE_DOUBLE_IMAGEBUTTON);
		mHeaderLayout.setTitleAndLeftImageButton(titleName, leftTitle, R.drawable.base_action_bar_back_bg_selector, new OnLeftButtonClickListener());
	}
